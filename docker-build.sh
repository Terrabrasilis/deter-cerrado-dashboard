...
docker build -t terrabrasilis/cerrado-alert-aggregated:v$VERSION --build-arg VERSION=$VERSION --build-arg INDEX_FILE=deter-cerrado-aggregated -f environment/Dockerfile .
