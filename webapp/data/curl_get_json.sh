...
URL="http://terrabrasilis.dpi.inpe.br/geoserver/deter-cerrado/wfs?SERVICE=WFS&REQUEST=GetFeature&VERSION=2.0.0&TYPENAME=cloud_m_d&OUTPUTFORMAT=application%2Fjson"
...
URL="http://terrabrasilis.dpi.inpe.br/geoserver/deter-cerrado/wfs?SERVICE=WFS&REQUEST=GetFeature&VERSION=2.0.0&TYPENAME=all_daily_d&OUTPUTFORMAT=application%2Fjson"
...
URL="http://terrabrasilis.dpi.inpe.br/geoserver/deter-cerrado/wfs?SERVICE=WFS&REQUEST=GetFeature&VERSION=2.0.0&TYPENAME=month_d&OUTPUTFORMAT=application%2Fjson"
