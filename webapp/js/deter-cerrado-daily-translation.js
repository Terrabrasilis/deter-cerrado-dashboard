var Translation={
	'pt-br':{
		...
		'tituloprint':' | Alertas diários de desmatamento no Cerrado Brasileiro (DETER).',
	...
	'en':{
		...
		'radio-alerts':'See the charts based on sum of number of alerts.',
		'print_page':'Print this page using the browser resources.',
		/* Texts inside javascript. */
		'areas':'area',
		'alerta':'alert',
		'alertas':'number of alerts',
		'unit_alerts':'alerts',
		...
		'tituloprint':' | Daily alerts of the deforestation in Brazilian Cerrado (DETER).',
		/* For about modal window  */
