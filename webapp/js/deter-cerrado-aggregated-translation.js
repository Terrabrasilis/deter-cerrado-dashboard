var Translation={
	'pt-br':{
		...
		'title-chart-agreg':'Variação mensal de área do projeto DETER - ano referência (Agosto a Julho)',
		'title-chart-by-state':'Área por Estados',
		'title-chart-by-year':'Área por Anos',
		'txt16':'Filtros por Estados e ano referência (Agosto a Julho)',
		...
		'area': 'Área Agregada',
		'unit': 'km²',
		'warning_class':'Classe válida apenas para o ano referência 2015/2016',
		'barArea_x_label':'Ano referência (Agosto - Julho)',
		'tools': 'Ferramentas',
		'help' : 'Ajuda',
		...
		'tt-contactus-menu': 'Envie-nos um e-mail com sugestões ou dúvidas sobre o projeto (terrabrasilis@dpi.inpe.br)',
		'about-menu':'Sobre',
	...
	'en':{
		...
		'title-chart-agreg':'Monthly variation of DETER project area - reference year (August to July)',
		'title-chart-by-state':'Area by States',
		'title-chart-by-year':'Area by Years',
		'txt16':'Filters by States and reference year (August to July).',
		...
		'txt25':'Close',
		'txt26':'Download table with the notices in CSV format.',
		'txt27':'With filters.',
		...
		'unit': 'km²',
		'warning_class':'Class valid only for reference year 2015/1016',
		'barArea_x_label':'Reference year (August - July)',
		'tools': 'Tools',
		'help' : 'Help',
		...
		'tt-contactus-menu': 'Send us an e-mail with suggestions or questions about the project (terrabrasilis@dpi.inpe.br)',
		'about-menu':'About',
