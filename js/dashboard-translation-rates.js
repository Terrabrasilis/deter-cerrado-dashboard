var Translation={
	'pt-br':{
		...
		'txt5':'Escuro/Claro',
		'txt6':'Entrar',
		'txt7':'Taxas anuais de desmatamento no Bioma Cerrado (versão Demonstração - NUMEROS SUJEITOS A ALTERACOES)',
		'txt8':'Filtro:',
		...
		'txt15':'Taxas de desmatamento anuais e variações relativas no Bioma Cerrado',
		...
		'txt20':'Obs: 2001, 2003, 2005, 2007, 2009, 2011, 2012 e 2014 representam média com o ano subsequente, pois não houve mapeamentos nestes anos.</strong>',
		'txt21':'',
		/*'txt22':'2004 - início do',*/
		'txt23':'Para mais informações, acesse site do projeto',
		'txt24':'Fechar',
		...
		'barXAxis':'Período de monitoramento no Bioma Cerrado: ',
		'area':'Área: ',
		'state':'Estado: ',
		'year':'Ano: ',
		'percent':'Porcentagem: ',
		'lineYAxis':'Estimativa anual de desmatamento (km²/ano)',
		'lineXAxis':'Período de monitoramento no Bioma Cerrado: ',
	...
	'en':{
		...
		'txt5':'Dark/Light',
		'txt6':'Login',
		'txt7':'Annual deforestation rate in the Cerrado',
		'txt8':'Filter:',
		...
		'txt15':'Annual deforestation rate and relative variation in the Biome Cerrado (AMZ)',
		...
		'barXAxis':'Biome Cerrado Monitoring Period: ',
		'area':'Area: ',
		'state':'State: ',
		'year':'Year: ',
		'percent':'Percentage: ',
		'lineYAxis':'Annual deforestation area by State (km²/year)',
		'lineXAxis':'Biome Cerrado Monitoring Period: ',
